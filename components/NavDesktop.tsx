  ...
  return (
    <div className="hidden lg:flex lg:flex-row items-center justify-center content-center">
      <div className="flex flex-col ml-40">
        <h1 className="text-[90px] font-bold">Dwikavindra</h1>
        <h1 className="text-[90px] font-bold">Haryo</h1>
        <h1 className="text-[90px] font-bold">Radithya</h1>
      </div>
      <div className="flex flex-col ml-[200px] justify-center items-center content-center mt-10">
