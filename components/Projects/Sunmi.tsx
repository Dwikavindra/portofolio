      ...
      <div className="self-center mt-4 ">
        <div className="rounded-[20px] pl-5 pt-5 pr-5 pb-2 bg-white text-black w-[300px] font-extrabold mt-10">
          <p className="text-3xl">
            An in development package that {`I'm`} working on to integrate
            esc-pos printer especially sunmi printers since not many
            react-native package works accordingly with full bluetooth LE
            capabilities using Kotlin. The future plan is to also make this
            available for IOS
          </p>
